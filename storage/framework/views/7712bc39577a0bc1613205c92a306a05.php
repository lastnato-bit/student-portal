...
>
    ...
    >
        ...
        <div x-data x-init="$store.sidebar = $store.sidebar || { isOpen: true }"></div>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1145585783-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\student-portal\resources\views/vendor/filament-panels/components/layout/base.blade.php ENDPATH**/ ?>