<div class="w-full max-w-md mx-auto py-12">
    ...
    <form wire:submit.prevent="login" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <h2 class="text-2xl font-bold mb-4 text-center">Superadmin Login</h2>
        ...
        <div class="mb-6 text-right">
            <a href="{{ route('superadmin.password.request') }}" class="text-sm text-indigo-600 hover:underline">
        ...
        <div class="text-center">
            <a href="{{ route('superadmin.register') }}" class="text-sm text-indigo-600 hover:underline">
