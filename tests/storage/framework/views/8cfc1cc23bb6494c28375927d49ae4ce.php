                ...
                <table class="w-full text-sm table-auto border">
                    <thead class="bg-gray-100">
                        <tr>
                            ...
                            <th class="px-3 py-2 border">Room</th>
                        </tr>
                    </thead>
                    <tbody>
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="px-3 py-2 border"><?php echo e($schedule->subject); ?></td>
                                <td class="px-3 py-2 border capitalize"><?php echo e($schedule->day); ?></td>
                                ...
                                <td class="px-3 py-2 border"><?php echo e($schedule->room); ?></td>
                            </tr>
